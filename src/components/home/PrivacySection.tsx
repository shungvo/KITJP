...
export default function PrivacySection() {
  const { data, loading, error } = usePrivacyData()
  ...
  return (
    <AnimatedSection className="py-16 px-4 bg-gray-50 dark:bg-gray-800" aria-labelledby="privacy-heading">
      <div className="container mx-auto max-w-4xl">
        <SectionHeader title={data.title} subtitle={data.subtitle} id="privacy-heading" />
